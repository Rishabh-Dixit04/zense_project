...
class NewCollectDueReceive extends StatefulWidget {
   Map element;
  NewCollectDueReceive(this.element,{Key? key}) : super(key: key){}


  @override
  State<NewCollectDueReceive> createState() => _NewCollectDueReceiveState();
}

class _NewCollectDueReceiveState extends State<NewCollectDueReceive> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var doc in documents) {
      if (doc['name'] == accountName) {
        ...
        int newMoney = currentMoney + amount;
          ...
          _collectDuesReference.doc(widget.element['id']).delete();
    ...
    return Form(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            Text('Collect amount',style: TextStyle(fontSize: 20)),
            SizedBox(height: 20,),
            Dropdownforaccounts(),
