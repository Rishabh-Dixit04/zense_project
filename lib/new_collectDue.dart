...
class NewCollectDue extends StatefulWidget {
  const NewCollectDue({super.key});

  @override
  State<NewCollectDue> createState() => _NewCollectDueState();
}

class _NewCollectDueState extends State<NewCollectDue> {
                              ...
                              child: IconButton(
                                  ...
                                  onPressed: () async{
                                    ...
                                    if (_formkey.currentState!.validate()){
                                      ...
                                      //print(toAdd);
                                      _collectDuesReference.add(toAdd);
